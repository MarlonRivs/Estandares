    ...
    <head>
        ...
        <style>
            *{
            ...
            body{ background-image: url("img/nv2.jpg"); background-size: cover; background-repeat: no-repeat; margin-top: -120px;  background-attachment: fixed;overflow-x: hidden;}
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="card-body" style="color: black;">        
                                      ...
                                      <form action="productoVistaaccesorio.jsp" method="post">
