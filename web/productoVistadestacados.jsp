...
<html>
    ...
    <body>
        ...
        <div class="card container" style="margin-bottom:-20px; padding: -10px; margin-top: 150px; ">
            <div class="row mt-4">
                <div class="col-md-12" style="padding:10px;  " id="producto_<%= request.getParameter("id_destacados")%>">
                    <div class="product-card">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="padding:80px;">
                                ...
                                <br><p id="precio_<%= request.getParameter("id_destacados")%>">Precio: $<span class="precio-unitario"><%= request.getParameter("precio")%></span></p>
                                <div class="mb-3">
                                    <br><label for="cantidad_<%= request.getParameter("id_destacados")%>" class="form-label">Cantidad:</label><br>
                                    <br><input type="number" class="form-control cantidad" id="cantidad_<%= request.getParameter("id_destacados")%>"
                                               name="cantidad" value="0" min="0" data-id="<%= request.getParameter("id_destacados")%>">
                                ...
                                <form action="almacen.jsp" method="post">
                                    ...
                                    <input type="hidden" name="id_sofa" value="<%= request.getParameter("id_destacados")%>">
        ...
        <script>
            function validarCantidad() {
                ...
                var cantidad = document.getElementById("cantidad_<%= request.getParameter("id_destacados")%>").value;
