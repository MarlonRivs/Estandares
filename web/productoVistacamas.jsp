                    ...
                    <div class="product-card">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="padding:80px;">
                                ...
                                <br><p id="precio_<%= request.getParameter("id_cama")%>">Precio: $<span class="precio-unitario"><%= request.getParameter("precio")%></span></p>
                                <div class="mb-3">
                                    <br><label for="cantidad_<%= request.getParameter("id_cama")%>" class="form-label">Cantidad:</label><br>
                                    <br><input type="number" class="form-control cantidad" id="cantidad_<%= request.getParameter("id_cama")%>"
                                           name="cantidad" value="0" min="0" data-id="<%= request.getParameter("id_cama")%>">
                            ...
                            <div class="col-md-6" style="padding:30px;">
                                ...
                                <div class="card container" style="padding-top: 10px; margin-top: -90px; margin-bottom: 100px; background-color: black; color:white;">
                                    ...
                                    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                                        <script>
                                                function validarCantidad() {
                                                    ...
                                                    var cantidad = document.getElementById("cantidad_<%= request.getParameter("id_cama")%>").value;
